    ...
    >
      <div className="w-[50%] flex items-center justify-center">
        {pathname === '/dashboard/employer' ? (
          <span className="sm:text-[25px] text-[20px] text-center sm:p-[10px] p-[5px] rounded-[5px]" style={{ color: colour , backgroundColor: background}}>
            {icon}
          </span>
        ) : (
      ...
      <div className="text-center w-[50%]">
        <h1 className="sm:text-[30px] text-[20px] font-bold">{count < 10 ? `0${count}` : count}</h1>
